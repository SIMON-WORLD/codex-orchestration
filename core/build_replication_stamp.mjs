...
if (isMain) {
  ...
  const sourceHashes = { model_registry: sha256(readFileSync(mPath)), estimates: sha256(readFileSync(ePath)) };
  if (dPath) sourceHashes.diagnostics = sha256(readFileSync(dPath));
